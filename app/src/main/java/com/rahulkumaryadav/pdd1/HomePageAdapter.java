...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class StripAdBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.placeholder_icon)).into(stripAdImage);
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList,String title,String color){
           container.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(color)));
            ...
            for (int x =0;x<4;x++){
                ...
                TextView productAvailability = gridProductLayout.getChildAt(x).findViewById(R.id.h_s_product_availabilty);
                ...
                productAvailability.setText(horizontalProductScrollModelList.get(x).getProductAvailability());
